...
# ============== ADMIN — ACCESOS AUTORIZADOS (cortesía / pruebas) ==============
# Emails con acceso gratis: uso interno del equipo o pruebas a clientes (valuador/inmobiliaria).
# Cada acceso da "acceso total" o un número de avalúos gratis, con una modalidad de servicio
# (solo valuación / con servicio de valuador = addon_valuador / con visita = addon_visita),
# y opcionalmente una fecha de expiración. Se agota lo que ocurra primero (cupo o fecha).
...
@api_router.put("/admin/accesos/{access_id}")
...
@api_router.delete("/admin/accesos/{access_id}")
