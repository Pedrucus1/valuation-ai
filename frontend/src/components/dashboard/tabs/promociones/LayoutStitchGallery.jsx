...
export default function LayoutStitchGallery({
  ...
  const galleryImages = fotos.length >= 6
    ? fotos.slice(0, 6)
    : [
        ...fotos,
        ...Array(Math.max(0, 6 - fotos.length)).fill(null),
      ];
    ...
    >
      ...
      >
        ...
        <section className="mb-6">
          <div className="w-full h-14 overflow-hidden" style={{ height: '56px' }}>
            {heroImg ? (
              <img
                alt="Vista principal"
        ...
        {/* Specs Row */}
        <section className="mb-6">
          <div className="border-b border-t border-gray-300 py-3 mb-6">
            <div className="flex justify-between items-center">
              <div className="flex flex-col">
                <span className="text-[10px] text-gray-400 uppercase tracking-widest">Precio</span>
                <span
                  className="text-[20px] font-semibold"
                  style={{ color: '#775a19', fontFamily: 'Playfair Display, Georgia, serif' }}
                >
                  {precio}
                </span>
              </div>
              <div className="flex flex-col">
                <span className="text-[10px] text-gray-400 uppercase tracking-widest">Construcción</span>
                <span className="text-base font-bold text-gray-800">{construccion}</span>
              </div>
              <div className="flex flex-col">
                <span className="text-[10px] text-gray-400 uppercase tracking-widest">Terreno</span>
                <span className="text-base font-bold text-gray-800">{terreno}</span>
              </div>
              <div className="flex flex-col">
                <span className="text-[10px] text-gray-400 uppercase tracking-widest">Recámaras</span>
              ...
              <div className="flex flex-col">
                <span className="text-[10px] text-gray-400 uppercase tracking-widest">Baños</span>
                <div className="flex items-center gap-1">
              ...
              <div className="flex flex-col">
                <span className="text-[10px] text-gray-400 uppercase tracking-widest">Estac.</span>
                <div className="flex items-center gap-1">
                  <Car size={14} className="text-black" />
                  <span className="text-base font-bold text-gray-800">{estacionamiento}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-3xl">
            <h2 className="text-[10px] text-gray-400 uppercase tracking-widest mb-2">
              Descripción
            </h2>
            <p
              className="text-[16px] text-gray-900 leading-tight italic border-l-4 pl-6 py-1 mb-3"
