  ...
  return (
    <AdminLayout>
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <PageHeader icon={Wrench} title="Modo Mantenimiento"
          subtitle="Muestra un banner global o bloquea rutas específicas">
          <button onClick={() => setPreview((p) => !p)}
            className="flex items-center gap-2 bg-white/20 hover:bg-white/30 border border-white/30 text-white text-sm font-semibold px-4 py-2.5 rounded-xl transition-colors">
            <Eye className="w-4 h-4" /> Preview
          </button>
          <button onClick={guardar}
            className={`flex items-center gap-2 text-sm font-bold px-4 py-2.5 rounded-xl transition-colors ${
              config.activo ? "bg-red-400 hover:bg-red-500 text-white" : "bg-[#D9ED92] hover:bg-white text-[#1B4332]"
            }`}>
        ...
        <div className="bg-white rounded-2xl border border-[#B7E4C7] shadow-sm p-6 space-y-5">
