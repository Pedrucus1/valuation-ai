        ...
        <div className="bg-white rounded-2xl border border-[#B7E4C7] shadow-sm overflow-hidden">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="bg-gradient-to-r from-[#1B4332] to-[#2D6A4F]">
                  {["Portal", "Estado", "Propiedades", "Completadas", "Errores", "Pendientes", "Última act.", ""].map((h) => (
                ...
                {status.portales.map((p) => {
                  ...
                  return (
                    <tr key={p.id} className="hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className="px-4 py-3 text-sm font-semibold text-[#1B4332]">{(p.propiedades ?? 0).toLocaleString()}</td>
                      <td className="px-4 py-3 text-sm text-slate-600">{(p.completadas ?? 0).toLocaleString()}</td>
                      <td className="px-4 py-3">
