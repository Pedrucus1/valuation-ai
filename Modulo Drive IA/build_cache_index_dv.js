...
const OUT_PATH   = path.join(__dirname, 'cache_index_dv.json');  // #121 experimento: NO toca caché de producción
...
for (const d of CACHE) {
    ...
    idx[muni][tipo][col].push({ precio: d.precio, m2c: d.m2c, m2t: d.m2t || 0, fecha: d.fecha || null, anio: d.anio || null,
        recamaras: d.recamaras || 0, banos: d.banos || 0, estac: d.estac || 0 });  // #121: vars para DV
}
