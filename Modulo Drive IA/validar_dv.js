...
const { valuarPropiedadCompleto, normTipo } = require('./motor_remi_api_dv');  // #121 experimento
...
for (const opi of muestra) {
    ...
    const prop = {
        ...
        estacionamientos:  parsePesos(opi.estacionamientos) || 0,  // #121: sin default fabricado
